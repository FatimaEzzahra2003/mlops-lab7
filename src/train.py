...
# Constante MLflow demandée par le prof (Étape 2)
...
def main(version: str = "v1", seed: int = 42, gate_f1: float = 0.70) -> None:
    ...
    # ====== BLOC MLFLOW (Étape 3 – emplacement EXACT) ======
    ...
    print(f"[OK] Modèle sauvegardé (versionné) : {model_path}")
    print(f"[OK] Modèle sauvegardé (stable) : {stable_model_path}")
